    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <div>
              <form action="<?php echo base_url('super_admin/searchtax')?>" class="form-horizontal" method="post" role="form">
              <fieldset>
                <legend></legend>
                <div class="form-group">
                  ...
                  <div class="input-group date form_datetime col-md-5" data-date-format="yyyy-mm" data-link-field="dtp_input1">
                    ...
                    <span class="input-group-btn"><a href="<?php echo base_url('super_admin/wage_tax_import') ?>" class="btn btn-warning" style="width:80px;margin-left:5px">上传</a></span>
                    ...
                    <div class="modal-month fade" tabindex="-1" data-backdrop="false" role="dialog" id="myModal">
                      <div class="modal-content-month">
                        ...
                        <div class="modal-footer">
                          <form action='<?php echo base_url('super_admin/wage_tax_delete')?>' method='POST'>
                          <?php if($chosen_month):?>
