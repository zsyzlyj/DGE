      ...
      <div class="row">
        ...
        <?php if($this->session->flashdata('success')): ?>
          ...
          <div class="box">
            <div class="box-body">
              <div>
                <form class="form-horizontal" action="<?php echo base_url('super_admin/wage_export')?>" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                  <fieldset>
                    <div id="legend" class="">
                      <legend class=""></legend>
                    </div>
